...
class Model(torch.nn.Module):
    def __init__(self, input_shape, sequence_length, kernels_count = 64, hidden_count = 256):
...
if __name__ == "__main__":
    ...
    states          = torch.randn(( batch_size, sequence_length) + state_shape, requires_grad=True)
