...
#files = []
#files.append("./models/dqn_curiosity/result/result.log")
#rl_stats_compute_curiosity_entropy = RLStatsCompute(files, result_path + "dqn_curiosity_imagination.log") 
...
#plt.plot(rl_stats_compute_curiosity_entropy.games_mean, rl_stats_compute_curiosity_entropy.episode_mean, label="dqn curiosity entropy", color='red')
#plt.fill_between(rl_stats_compute_curiosity_entropy.games_mean, rl_stats_compute_curiosity_entropy.episode_lower, rl_stats_compute_curiosity_entropy.episode_upper, color='red', alpha=0.2)
...
#plt.plot(rl_stats_compute_curiosity_entropy.iterations, rl_stats_compute_curiosity_entropy.episode_mean, label="dqn curiosity entropy", color='red')
#plt.fill_between(rl_stats_compute_curiosity_entropy.iterations, rl_stats_compute_curiosity_entropy.episode_lower, rl_stats_compute_curiosity_entropy.episode_upper, color='red', alpha=0.2)
...
#plt.plot(rl_stats_compute_curiosity_entropy.iterations, rl_stats_compute_curiosity_entropy.curiosity_mean, label="curiosity entropy", color='red')
#plt.fill_between(rl_stats_compute_curiosity_entropy.iterations, rl_stats_compute_curiosity_entropy.curiosity_lower, rl_stats_compute_curiosity_entropy.curiosity_upper, color='red', alpha=0.2)
...
plt.plot(rl_stats_compute_curiosity_entropy.iterations, rl_stats_compute_curiosity_entropy.forward_loss_mean, label="curiosity entropy", color='blue')
plt.fill_between(rl_stats_compute_curiosity_entropy.iterations, rl_stats_compute_curiosity_entropy.forward_loss_lower, rl_stats_compute_curiosity_entropy.forward_loss_upper, color='blue', alpha=0.2)
