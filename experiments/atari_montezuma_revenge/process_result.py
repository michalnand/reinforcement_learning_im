...
plt.plot(rl_stats_compute_curiosity_em.games_mean, rl_stats_compute_curiosity_em.episode_mean, label="dqn curiosity goals", color='red')
...
plt.plot(rl_stats_compute_curiosity_em.iterations, rl_stats_compute_curiosity_em.episode_mean, label="dqn curiosity episodic memory", color='red')
...
plt.plot(rl_stats_compute_curiosity_em.iterations, rl_stats_compute_curiosity_em.curiosity_mean, label="curiosity episodic memory", color='red')
...
plt.plot(rl_stats_compute_curiosity_em.iterations, rl_stats_compute_curiosity_em.forward_loss_mean, label="curiosity episodic memory", color='blue')
plt.fill_between(rl_stats_compute_curiosity_em.iterations, rl_stats_compute_curiosity_em.forward_loss_lower, rl_stats_compute_curiosity_em.forward_loss_upper, color='blue', alpha=0.2)
